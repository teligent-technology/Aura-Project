        ...
        <Container>
          <Row>
            <Col md={12}>
              ...
              <h2 className="terms-subheading">9. Accessibility</h2>
              <p className="terms-text">
              ...
              <h2 className="terms-subheading">10. Governing Law</h2>
              <p className="terms-text">
              ...
              <h2 className="terms-subheading">11. Changes to Terms</h2>
              <p className="terms-text">
              ...
              <h2 className="terms-subheading">12. Contact Us</h2>
              <p className="terms-text">
